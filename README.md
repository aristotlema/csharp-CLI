...
Acknowledgement
--------------
This repo is a nearly direct copy of https://github.com/karan/Projects at this time. 

The pourpose of this repo will ultimatley be to be a code base of solved challenges to be used as reference, not a list of "To do" challenges. Projects may be added and removed and the formatting may change. Karan's project is just being used as a jumping off point.

I will update this readme later to better reflect the pourpose of this repo.
